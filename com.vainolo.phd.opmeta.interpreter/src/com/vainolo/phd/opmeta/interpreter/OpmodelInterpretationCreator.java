...
//			return null;
//		}
//		container = null;// (OpmodelContainerInstance)factory.createOpmodelInstance(rootContainer);
//		if (container != null)
...
//			OpmodelThingInstance thing = null; //(OpmodelThingInstance)factory.createOpmodelInstance((ThingInstanceBase)baseNode);
//			if (thing != null)
//				fillContainer((ContainerInstanceBase)baseNode,thing);
//			node = thing;
//		} else {
//			node = null;//(OpmodelNodeInstance)factory.createOpmodelInstance(baseNode);
//		}		
//		
//		return node;
//	}
...
//			return null;
//		}
//		link = null;//(OpmodelLinkInstance)factory.createOpmodelInstance(linkBase);
