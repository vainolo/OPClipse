...
public class OpmetaInterpreterTester {
	...
	public void testSimpleFileCreateInterpretation() {
		OPMetaModelDiagram systemDiagram = TesterUtils
				.createBasicMetaModelDiag();

		OPmodelHolder opmodelHolder = OpmetaInterpreter
				.CreateOPmodelHolder(systemDiagram);
		opmodelHolder.setContainer(opmodelFactory.eINSTANCE
		...
		resourceSet.getPackageRegistry().put(OPMPackage.eNS_URI,
				OPMPackage.eINSTANCE);
		resourceSet.getPackageRegistry().put(opmetaPackage.eNS_URI,
				opmetaPackage.eINSTANCE);
		resourceSet.getPackageRegistry().put(opmodelPackage.eNS_URI,
				opmodelPackage.eINSTANCE);
		Resource resource = resourceSet.createResource(URI
				.createFileURI("c:\\temp\\test4.opmodel"));
	...
	@Test
	public void testSimpleCreateInterpretation() {
		OPMetaModelDiagram systemDiagram = TesterUtils
				.createBasicMetaModelDiag();
		...
		assertTrue(((curr.getProperties().get(0).getType() == propertyType.BOOLEAN) && (curr
				.getProperties().get(1).getType() == propertyType.FLOAT))
				|| ((curr.getProperties().get(0).getType() == propertyType.FLOAT) && (curr
						.getProperties().get(1).getType() == propertyType.BOOLEAN)));

		TypeDescriptor type1 = getDescriptor(interpretation.getContainers(),
				"Thing");
		TypeDescriptor type2 = getDescriptor(interpretation.getNodes(), "Thing");
		assertNotNull(type1);
		assertSame(type1, type2);
		propertyType[] expectedTypes = new propertyType[] {
				propertyType.STRING, propertyType.INT, propertyType.STRING,
	...
	@Test
	public void testSimpleDiamondCreateInterpretation() {
		OPMetaModelDiagram basicDiag = opmetaFactory.eINSTANCE
				.createOPMetaModelDiagram();
		basicDiag.setElementsDiagram(OPMFactory.eINSTANCE
				.createOPMObjectProcessDiagram());
		basicDiag.setLinksDiagram(OPMFactory.eINSTANCE
				.createOPMObjectProcessDiagram());
		...
		OPMNode nodeGrandSon = TesterUtils.createObject("NodeGrandSon",
				opmDiagram);
		...
		TypeDescriptor testable = getDescriptor(interpretation.getNodes(),
				"NodeGrandSon");
		assertEquals(2, testable.getParents().size());
		assertTrue(testable.getParents().contains(
				getDescriptor(interpretation.getNodes(), "NodeSon1")));
		assertTrue(testable.getParents().contains(
				getDescriptor(interpretation.getNodes(), "NodeSon2")));
		testable = getDescriptor(interpretation.getNodes(), "Node");
		assertEquals(2, testable.getChildren().size());
		assertTrue(testable.getChildren().contains(
				getDescriptor(interpretation.getNodes(), "NodeSon1")));
		assertTrue(testable.getChildren().contains(
				getDescriptor(interpretation.getNodes(), "NodeSon2")));
	}
	...
	@Test
	public void testDiffLevelsDiamondCreateInterpretation() {
		OPMetaModelDiagram basicDiag = opmetaFactory.eINSTANCE
				.createOPMetaModelDiagram();
		basicDiag.setElementsDiagram(OPMFactory.eINSTANCE
				.createOPMObjectProcessDiagram());
		...
		assertEquals(2, testable.getParents().size());
		assertTrue(testable.getParents().contains(
				getDescriptor(interpretation.getNodes(), "NodeSon")));
		assertTrue(testable.getParents().contains(
				getDescriptor(interpretation.getNodes(), "NodeLevel3")));
		testable = getDescriptor(interpretation.getNodes(), "Node");
		assertEquals(2, testable.getChildren().size());
		assertTrue(testable.getChildren().contains(
				getDescriptor(interpretation.getNodes(), "NodeLevel1")));
		assertTrue(testable.getChildren().contains(
				getDescriptor(interpretation.getNodes(), "NodeSon")));
	}

	@Test
	public void testSimpleDiamondPropertiesPassCreateInterpretation() {
		OPMetaModelDiagram basicDiag = opmetaFactory.eINSTANCE
				.createOPMetaModelDiagram();
		basicDiag.setElementsDiagram(OPMFactory.eINSTANCE
				.createOPMObjectProcessDiagram());
		...
		OPMObjectProcessDiagram opmDiagram = basicDiag.getElementsDiagram();
		OPMNode node = TesterUtils.createObject("Node", opmDiagram);
		OPMNode nodeProp = TesterUtils.createObject("NodeProp:String",
				opmDiagram);
		TesterUtils.createObject("Container", opmDiagram);
		OPMNode nodeSon1 = TesterUtils.createObject("NodeSon1", opmDiagram);
		OPMNode node1Prop = TesterUtils.createObject("Node1Prop:int",
				opmDiagram);
		OPMNode nodeSon2 = TesterUtils.createObject("NodeSon2", opmDiagram);
		OPMNode node2Prop = TesterUtils.createObject("Node2Prop:String",
				opmDiagram);
		OPMNode nodeGrandSon = TesterUtils.createObject("NodeGrandSon",
				opmDiagram);
		OPMNode node3Prop = TesterUtils.createObject("Node3Prop:String",
				opmDiagram);
		TesterUtils.createObject("Link", basicDiag.getLinksDiagram());
		...
		propertyType[] expectedTypes = new propertyType[] {
				propertyType.STRING, propertyType.INT, propertyType.STRING,
				propertyType.STRING };
		String[] expectedNames = new String[] { "Node3Prop", "Node1Prop",
				"NodeProp", "Node2Prop" };
		List<propertyType> actualTypes = new LinkedList<propertyType>();
	...
	@Test
	public void testMultiInheritenceOfSameTypeProperties() {
		OPMetaModelDiagram basicDiag = opmetaFactory.eINSTANCE
				.createOPMetaModelDiagram();
		basicDiag.setElementsDiagram(OPMFactory.eINSTANCE
				.createOPMObjectProcessDiagram());
		...
		OPMNode containerProp = TesterUtils.createObject("Prop:String",
				opmDiagram);
	...
	@Test
	public void testMultiInheritenceOfDiffTypeProperties() {
		OPMetaModelDiagram basicDiag = opmetaFactory.eINSTANCE
				.createOPMetaModelDiagram();
		basicDiag.setElementsDiagram(OPMFactory.eINSTANCE
				.createOPMObjectProcessDiagram());
	...
	@Test
	public void testSimpleDiamondSinglePropCreateInterpretation() {
		// if testSimpleDiamondCreateInterpretation doesn't pass - this is
		// useless
	...
	@Test
	public void testCreateThingAndPassPropertiesInterpretation() {
		OPMetaModelDiagram basicDiag = opmetaFactory.eINSTANCE
				.createOPMetaModelDiagram();
		basicDiag.setElementsDiagram(OPMFactory.eINSTANCE
				.createOPMObjectProcessDiagram());
		...
		// check that exists in containers as well
		TypeDescriptor testable2 =  getDescriptor(interpretation.getContainers(), "Thing1");
		assertSame(testable, testable2);

	}

	private void testCreateThingAndPassPropertiesInterpretationTestProperties(
			TypeDescriptor testable) {
	...
	private static TypeDescriptor getDescriptor(
			Iterable<TypeDescriptor> descriptors, String name) {
		for (TypeDescriptor descriptor : descriptors) {
