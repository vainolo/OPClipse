...
public class OPMNodeItemProvider
	 ...
	 * @generated
	 */
	public OPMNodeItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addIncomingLinksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OPMNode_incomingLinks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OPMNode_incomingLinks_feature", "_UI_OPMNode_type"),
				 OPMPackage.Literals.OPM_NODE__INCOMING_LINKS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutgoingLinksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OPMNode_outgoingLinks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OPMNode_outgoingLinks_feature", "_UI_OPMNode_type"),
				 OPMPackage.Literals.OPM_NODE__OUTGOING_LINKS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((OPMNode)object).getName();
