  ...
  /**
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OPMPackage.Literals.OPM_OBJECT_PROCESS_DIAGRAM__LINKS,
				 OPMFactory.eINSTANCE.createOPMInvocationLink()));
		...
		newChildDescriptors.add
			(createChildParameter
				(OPMPackage.Literals.OPM_OBJECT_PROCESS_DIAGRAM__LINKS,
				 OPMFactory.eINSTANCE.createOPMAggregationLink()));

		newChildDescriptors.add
			(createChildParameter
				(OPMPackage.Literals.OPM_OBJECT_PROCESS_DIAGRAM__LINKS,
				 OPMFactory.eINSTANCE.createOPMExhibitionLink()));

		newChildDescriptors.add
			(createChildParameter
				(OPMPackage.Literals.OPM_OBJECT_PROCESS_DIAGRAM__LINKS,
				 OPMFactory.eINSTANCE.createOPMGeneralizationLink()));
	}
