 ...
 * @generated
 */
public class LinkInstanceBaseItemProvider
	 ...
	 * @generated
	 */
	public LinkInstanceBaseItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkInstanceBase_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkInstanceBase_source_feature", "_UI_LinkInstanceBase_type"),
				 opmetaPackage.Literals.LINK_INSTANCE_BASE__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkInstanceBase_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkInstanceBase_target_feature", "_UI_LinkInstanceBase_type"),
				 opmetaPackage.Literals.LINK_INSTANCE_BASE__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LinkInstanceBase"));
	}
