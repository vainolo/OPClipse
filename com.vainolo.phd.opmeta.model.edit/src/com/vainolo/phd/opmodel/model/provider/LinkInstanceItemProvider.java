...
/**
 * This is the item provider adapter for a {@link com.vainolo.phd.opmodel.model.LinkInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkInstanceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkInstance_bendpoints_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkInstance_bendpoints_feature", "_UI_LinkInstance_type"),
				 opmodelPackage.Literals.LINK_INSTANCE__BENDPOINTS,
				 true,
				 false,
				 false,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkInstance_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkInstance_target_feature", "_UI_LinkInstance_type"),
				 opmodelPackage.Literals.LINK_INSTANCE__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 opmodelPackage.Literals.LINK_INSTANCE__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		LinkInstance linkInstance = (LinkInstance)object;
		return getString("_UI_LinkInstance_type") + " " + linkInstance.getId();
	}
